...
<div class="mag-login-area py-5">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 row-cols-lg-12">
                <div class="login-content bg-white p-30 box-shadow">
                    ...
                    <form action="{{ route('user.register.submit') }}" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Prefix<span class="required-label">*</span></label>
                                ...
                                <div class="form-group">
                                    <label>Re-Type Password<span class="required-label">*</span></label>
                                ...
                                <div class="form-group">
                                    <label>Institution<span class="required-label">*</span></label>
                                    <input type="text" class="form-control @error('institution') is-invalid @enderror" name="institution" id="institution" placeholder="{{ __('Institution') }}">
                                    @error('institution')
                                    <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('department') is-invalid @enderror" name="department" id="department" placeholder="{{ __('Department') }}">
                                    @error('department')
                                    <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('city') is-invalid @enderror" name="city" id="city" placeholder="{{ __('City') }}">
                                    @error('city')
                                    <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                                ...
                                <div class="form-group">
                                    <label>Postal Code<span class="required-label">*</span></label>
                                    <input type="text" class="form-control @error('postal_code') is-invalid @enderror" name="postal_code" id="postal_code" placeholder="{{ __('Postal Code') }}">
                                    @error('postal_code')
                                    <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <button type="submit" class="btn mag-btn mt-30 offset-3">Register</button>
                        <div class="form-group">
