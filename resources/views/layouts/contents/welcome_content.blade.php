...
<section class="mag-posts-area d-flex flex-wrap">
    ...
    <div class="post-sidebar-area left-sidebar mt-30 mb-30 bg-white box-shadow">
        <!-- Sidebar Widget -->
        <div class="single-sidebar-widget p-30 h-auto">
                <!-- Section Title -->
                            ...
                            <div class="post-thumbnail">
                                <a href="{{ route('article.view', [$article->id]) }}">
                                    <img src="{{ asset('uploads/articles/covers/' . $article->upload_image) }}"
                                         style="width: 315px; height: 540px">
                                </a>
                            </div>
    ...
    <!-- Sidebar Widget -->
        <div class="single-sidebar-widget">
            ...
            <a href="{{ route('article.view', [$special->id]) }}" class="add-img"><img src="{{ asset('uploads/articles/covers/' . $special->upload_image) }}" alt=""></a>
            @endforeach
        </div>
                    ...
                    <div class="single-blog-post d-flex">
                        <div class="post-thumbnail">
                            <a href="{{ route('article.view', [$published->id]) }}">
                                <img src="{{ asset('uploads/articles/covers/' . $published->upload_image) }}"
                                     alt="Uploaded Files" style="width: 600px; height: 100px">
                            </a>
                        </div>
                        <div class="post-content">
                            <a href="{{ route('article.view', [$published->id]) }}" class="post-title"><strong>{{ $published->author }}</strong></a>
        ...
        <div class="trending-now-posts mb-30">
            ...
            <div class="trending-post-slides owl-carousel">
                ...
                <div class="single-trending-post">
                    <a href="{{ route('article.view', [$article->id]) }}">
                        <img src="{{ asset('uploads/articles/covers/' . $article->upload_image) }}" style="width: 500px; height: 343px">
                    </a>
                    <div class="post-content">
                    ...
                    <div class="col-12 col-lg-7">
                        ...
                        <div class="single-featured-post">
                            ...
                            <div class="post-thumbnail mb-50">
                                <img src="{{ asset('uploads/articles/covers/' . $special->upload_image) }}"
