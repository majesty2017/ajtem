                                ...
                                @foreach($manuscripts as $manuscript)
                                    <tr>
                                        ...
                                        @if($manuscript->manuscript)
                                            <td>
                                                <a href="{{ route('manuscript.downloadreviewed', [$manuscript->manuscript]) }}"><img src="{{ asset('uploads/manuscripts/default/default.jpg') }}" style="width: 70px; height: 70px" class="rounded"> Download</a>
                                            </td>
                                        @endif
